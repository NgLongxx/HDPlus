...
|
*/
//Route::any('admin/user/credit', 'AdminController@credit')->name('admin.user.credit');
...
Route::group(['prefix' => 'admin', 'middleware' => 'admin'], function(){
    ...
    Route::any('report/reports', 'AdminController@report')->name('admin.report.reports');;
    //Route::any('/user/credit', 'AdminController@user');
    //middleware auth yêu cầu đăng nhập khi vào trang admin hoặc userdetail 
});
