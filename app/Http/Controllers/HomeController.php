...
class HomeController extends Controller
{
    ...
    public function __construct(){
        $this->app_id = '1473504899662186';
        $this->app_secret = 'd2c470fa47ab77bb9f10eb92fab2828a';
    ...
    {
        $filmBo = Film::where([['type', 2], ['disable', 0]])->orderBy('id', 'DESC')->limit(24)->get(); //Lấy phim theo thứ tự giảm dần của id vơi orderby DESC/ASC 
